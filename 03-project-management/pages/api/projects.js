...
export default async function handler(req, res) {
  if (req.method === "GET") {
    ...
    try {
      // Update the specific document in the 'projects' collection
      const docRef = doc(db, "projects", updatedElement.id);
    ...
    try {
      // Delete the specific document from the 'projects' collection
