...
export default function Posts({ posts, users, comments, setRefetch }) {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-full w-full text-gray-900 p-8 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 bg-[length:400%_400%] animate-gradient-motion">
